...
<div id="container">
	...
	$(function(){
		$(".host_focus_done").click(function(){
			layer.confirm('<center><font color="#aaa"><div>作者贡献了<?=$rowPostCountOfAuthor["num"];?>篇文章</div><img src="<?=$this->options->dashang_qrcode;?>" alt="" width="200"><div>您的鼓励将是作者前行的动力</div><div>谢谢打赏</div></font></center>', {
				title:"打赏",
				btn: ['关闭']
			},function(index){
				layer.close(index);
